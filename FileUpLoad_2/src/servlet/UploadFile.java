...
@MultipartConfig(maxRequestSize = 100*1024*1024*2 ,maxFileSize =100*1024*1024 )
        ...
        for (Part part : parts) {
            ...
            if (filename != null) {
                ...
                if (conn == null) {
                    ...
                    String sql = "update 提交状态 set 状态=1 where 姓名=?";
                    try {
                        PreparedStatement pstmt = (PreparedStatement) conn.prepareStatement(sql);
                        pstmt.setString(1, parameter);
                        int rs=pstmt.executeUpdate();
                    } catch (SQLException e) {
                        res[2] = parameter + " 提交状态修改失败01";
                    }
                    ...
                    try {
                        ...
                        if (rs.next()) {
                            if (rs.getInt("状态") == 1) {
                                ...
                                res[2] = parameter + " 提交状态修改失败02;  now:"+rs.getInt("状态");
                            }
                        } else {
